...
def main():
    ...
    if not args.base_only:
        ...
        unitig_graph.save_to_fasta(args.base_only_prefix + '.fa')
        unitig_graph.save_to_gfa(args.base_only_prefix + '.gfa')
        output_result(args.base_only_prefix + '.fa', circularity)
